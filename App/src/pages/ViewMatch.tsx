...
const ViewMatch = () => {
	...
	const [userData, setUserData] = useState<MatchData | null>(null);
	...
	const [currUserData, setCurrUserData] = useState<CurrentUserData | null>(null);
				...
				<DrawerContent className="h-[60vh] transition-all">
					<div className="w-full h-full flex flex-col justify-evenly">
						...
						<div className="p-4">
							...
							<p>
								<b>Trip Cost:</b> ~{Math.floor(userData.tripCost ?? 0)} -{" "}
								{Math.floor((userData.tripCost ?? 0) + 0.3 * (userData.tripCost ?? 0))} /-
							</p>
